...
import 'package:chatbot_app/api/chat_network.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 32, 39, 77),
      ),
      // backgroundColor: const Color.fromARGB(255, 12, 13, 21),
      body: SafeArea(
        child: Column(
          children: [
            Expanded(
            ...
            Visibility(
              ...
              child: const Padding(
                ...
                child: CircularProgressIndicator(
                  color:  Color.fromARGB(255, 32, 39, 77),
                ),
              ),
            ),
            Padding(
